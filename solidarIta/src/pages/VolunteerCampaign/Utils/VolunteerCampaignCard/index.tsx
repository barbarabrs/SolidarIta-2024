...
interface VolunteerCampaignCardProps {
  title: string;
  status: string;
  username: string;
  id: number;
...
export function VolunteerCampaignCard(props: VolunteerCampaignCardProps) {
      ...
      >
        ...
        <Flex justifyContent={"space-between"}>
          <Button
            ...
            mr="2"
            onClick={() => {
              navigate(`/volunteerCampaign/log/${id}`);
            }}
          >
          ...
          {status === "Pendente" || status === "Em andamento" ? (
            <Button
              ...
              mr="2"
              onClick={() => {
                navigate(`/volunteerCampaign/edit/${id}`);
              }}
            >
              Editar
            </Button>
            ...
            <Button
              ...
              mr="2"
              onClick={() => {
                navigate(`/volunteerCampaign/accountability/${id}`);
              }}
            >
              Prestar conta
            </Button>
